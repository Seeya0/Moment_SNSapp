              ...
              <label>
                <div className="flex flex-col items-center justify-center h-full">
                  <div className="flex flex-col justify-center items-center">
                    ...
                    <p className="text-lg">アップロード</p>
                  </div>

                  <p className="mt-32 text-gray-400">
                    推奨： 20MB以下のJPG, JPEG, SVG, PNG, Gif or Tiff
                    を使用してください！
                  </p>
                </div>
                <input
          ...
          <div className="flex flex-col">
            <div>
              ...
              >
                ...
                {categories.map((item) => (
                  <option
                    className="text-black bg-white text-base border-0 outline-none capitalize"
                    value={item.name}
                  >
                    {item.name}
                  </option>
